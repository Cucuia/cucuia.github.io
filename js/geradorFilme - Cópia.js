...
[b]Subber: [/b] [cargo=user]${this.Subber}[/cargo] (CASO HAJA) 
...
[spoiler=MediaInfo][nfo]###### DADOS DO MEDIAINFO ######[/nfo][/spoiler]`;
    },
...
[ss]###### URL DA SCREENSHOT ######[/ss][ss]###### URL DA SCREENSHOT ######[/ss][/align]`;
    ...
    InserirTrailer: function () {
        var trailer = `${baseLib.StaticUrl.urlBaseTMDbTrailer + this.Data.TMDb.movie_results[0].video_path}`;
        
        return`\n[ttz]trailer[/ttz]
[align=center][tube]###### URL COMPLETO DO TRAILER NO YOUTUBE ######[/tube][/align]`;
    },
    
    InserirAgradecimentos: function () {
        return `\n[ttz]agradecimentos[/ttz]
[align=center]###### CASO QUEIRA AGRADECER ALGUÊM POR TER AJUDADO / CEDIDO ALGUMA COISA PARA O PROJETO, VIDEO, AUDIO, ETC... ######[/align]`;
    },
    
    InserirObservacoes: function () {
        return `\n[ttz]observacoes[/ttz]
[align=center]###### CASO QUEIRA INFORMAR ALGUMA COISA IMPORTANTE EM RELAÇÃO AO TÓPICO ######[/align]`;
    },
...
[servidor=###### NOME DO SERVIDOR TOTALMENTE MINUSCULO ######]###### LINK DO ARQUIVO ######[/servidor] [servidor=###### NOME DO SERVIDOR TOTALMENTE MINUSCULO ######]###### LINK DO ARQUIVO ######[/servidor]

###### Se for postar em diversas partes: ######
Parte 01 [servidor=###### NOME DO SERVIDOR TOTALMENTE MINUSCULO ######]###### LINK DO ARQUIVO ######[/servidor]
Parte 02 [servidor=###### NOME DO SERVIDOR TOTALMENTE MINUSCULO ######]###### LINK DO ARQUIVO ######[/servidor]
Parte 03 [servidor=###### NOME DO SERVIDOR TOTALMENTE MINUSCULO ######]###### LINK DO ARQUIVO ######[/servidor]
Parte 04 [servidor=###### NOME DO SERVIDOR TOTALMENTE MINUSCULO ######]###### LINK DO ARQUIVO ######[/servidor]
Parte 05 [servidor=###### NOME DO SERVIDOR TOTALMENTE MINUSCULO ######]###### LINK DO ARQUIVO ######[/servidor][/align][/spoiler][/hide]

[final][cargo=adm|mode|colab|amigo ou user]###### Nick do criador do tópico ######[/cargo][/final]`;
    },
